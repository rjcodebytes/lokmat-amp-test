...
export default function Support(props: any) {
    ...
    useEffect(() => {
        if (!slug) {
            console.log("Support: No slug provided");
            return;
        }
        
        console.log("Support: Fetching data for slug:", slug);
        console.log("Support: API URL:", customPageURL);
        
        cachedAxiosGet(customPageURL, axiosConfig)
            .then((result: any) => {
                console.log("Support: API Response:", result);
                const data = result?._data ?? result;
                console.log("Support: Extracted data:", data);
                ...
                if (Array.isArray(data)) {
                    ...
                    console.warn("Support: Unexpected data format:", data);
                    setCustomPages(null);
                }
            })
            .catch((error) => {
                console.error("Support: Error fetching custom page data:", error);
                setCustomPages(null);
            });
